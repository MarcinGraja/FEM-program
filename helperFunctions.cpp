...
double ** jacobian::getJacobian(element *e, double xi, double eta)
{
...
double jacobian::getJacobianDeterminant(element *e, double xi, double eta)
{
	double **jacobian = getJacobian(e, xi, eta);
	return (jacobian[0][0] * jacobian[1][1] - jacobian[0][1] * jacobian[1][0]);
}
double ** jacobian::getInverseJacobian(element *e, double xi, double eta)
{
	{
		double **returned = jacobian::getJacobian(e, xi, eta);
...
std::vector<matrix> shapeFunctions::getDerivatives(element *e, double xi, double eta)
{
...
matrix shapeFunctions::getShapeFunctionsValues(double xi, double eta)
{
